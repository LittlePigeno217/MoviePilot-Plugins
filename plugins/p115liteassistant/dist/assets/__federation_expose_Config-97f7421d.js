...
import { _ as _export_sfc, n as normalizeConfig, c as clone, a as pluginPost, p as pluginGet } from './_plugin-vue_export-helper-12555fbe.js';

const Config_vue_vue_type_style_index_0_scoped_e08db0dc_lang = '';

const Config_vue_vue_type_style_index_1_scoped_e08db0dc_lang = '';
...
const _hoisted_9 = { class: "work-grid auth-grid" };
const _hoisted_10 = { class: "field-lane" };
const _hoisted_11 = { class: "command-row" };
const _hoisted_12 = { class: "work-header" };
const _hoisted_13 = { class: "mapping-list" };
const _hoisted_14 = {
  key: 0,
  class: "empty-row"
};
const _hoisted_15 = { class: "work-header" };
const _hoisted_16 = { class: "head-switches" };
const _hoisted_17 = { class: "work-grid extension-grid" };
const _hoisted_18 = { class: "mapping-list" };
const _hoisted_19 = {
  key: 0,
  class: "empty-row"
};
const _hoisted_20 = { class: "work-header" };
const _hoisted_21 = { class: "work-grid checkin-grid" };
const _hoisted_22 = { class: "station-footer" };
const _hoisted_23 = { class: "save-state" };
const _hoisted_24 = { class: "qr-login-head" };
const _hoisted_25 = {
  key: 1,
  class: "qr-loading"
};
const _hoisted_26 = { class: "qr-client-types" };
const _hoisted_27 = {
  key: 0,
  class: "qr-code-stage"
};
const _hoisted_28 = { class: "qr-code-frame" };
const _hoisted_29 = ["src"];
const _hoisted_30 = { class: "picker-head" };
const _hoisted_31 = { class: "picker-toolbar" };
const _hoisted_32 = { class: "mono" };
                ...
                _createElementVNode("section", _hoisted_9, [
                  _createElementVNode("div", _hoisted_10, [
                    _createVNode(_component_v_text_field, {
                      modelValue: config.app_id,
                      "onUpdate:modelValue": _cache[7] || (_cache[7] = $event => ((config.app_id) = $event)),
                      label: "115 APP ID",
                      variant: "outlined",
                      density: "comfortable",
                      "hide-details": ""
                    ...
                    _createVNode(_component_v_textarea, {
                      ...
                      "onUpdate:modelValue": _cache[8] || (_cache[8] = $event => ((config.cookie) = $event)),
                      label: "115 Cookie",
                      rows: "4",
                      "auto-grow": "",
                      variant: "outlined",
                  ...
                  _createElementVNode("aside", {
                    ...
                    _createVNode(_component_v_icon, {
                      icon: connectionReady.value ? 'mdi-link-variant' : 'mdi-link-variant-off',
                      size: "28"
                    }, null, 8, ["icon"]),
                    _createElementVNode("strong", null, _toDisplayString(connectionReady.value ? '授权信息待校验' : '尚未配置授权信息'), 1)
                  ], 2)
                ])
              ]),
              _: 1
              ...
              default: _withCtx(() => [
                _createElementVNode("section", _hoisted_12, [
                  ...
                  _createVNode(_component_v_switch, {
                    ...
                    "onUpdate:modelValue": _cache[9] || (_cache[9] = $event => ((config.strm_incremental) = $event)),
                    label: "增量生成",
                    color: "primary",
                    "hide-details": "",
                    density: "compact",
                ...
                _createElementVNode("div", _hoisted_13, [
                  _cache[37] || (_cache[37] = _createElementVNode("div", { class: "mapping-caption" }, [
                  ...
                  (!config.strm_mappings.length)
                    ? (_openBlock(), _createElementBlock("div", _hoisted_14, "尚未添加映射"))
                    : _createCommentVNode("", true),
                  _createVNode(_component_v_btn, {
                    class: "station-add",
                    variant: "text",
            ...
            _createVNode(_component_v_window_item, { value: "upload" }, {
              default: _withCtx(() => [
                ...
                _createElementVNode("div", _hoisted_18, [
                  _cache[40] || (_cache[40] = _createElementVNode("div", { class: "mapping-caption" }, [
                  ...
                  (!config.upload_mappings.length)
                    ? (_openBlock(), _createElementBlock("div", _hoisted_19, "尚未添加上传目录"))
                    : _createCommentVNode("", true),
                  _createVNode(_component_v_btn, {
                    class: "station-add",
                    variant: "text",
          ...
          default: _withCtx(() => [
            _createElementVNode("div", _hoisted_24, [
              _createElementVNode("div", null, [
                ...
                _cache[44] || (_cache[44] = _createElementVNode("span", null, "115网盘扫码登录", -1))
              ]),
              _createVNode(_component_v_btn, {
                icon: "mdi-close",
                variant: "text",
              ...
              default: _withCtx(() => [
                ...
                (qrDialog.loading)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_25, [
                      ...
                      _cache[45] || (_cache[45] = _createElementVNode("span", null, "正在获取二维码", -1))
                    ]))
                  : (_openBlock(), _createElementBlock(_Fragment, { key: 2 }, [
                      _cache[47] || (_cache[47] = _createElementVNode("p", { class: "qr-login-label" }, "请选择扫码方式", -1)),
            ...
            _createVNode(_component_v_card_text, null, {
              default: _withCtx(() => [
                _createElementVNode("div", _hoisted_31, [
                  ...
                  _createElementVNode("span", _hoisted_32, _toDisplayString(isRemotePicker.value ? `/${picker.remoteTrail.map(item => item.name).join('/')}` || '/' : picker.path || picker.localBase || '/'), 1)
                ]),
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-e08db0dc"]]);
