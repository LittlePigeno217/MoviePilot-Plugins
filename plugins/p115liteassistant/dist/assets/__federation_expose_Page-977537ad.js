...
import { _ as _export_sfc, p as pluginGet, a as pluginPost } from './_plugin-vue_export-helper-12555fbe.js';

const Page_vue_vue_type_style_index_0_scoped_7b2e7782_lang = '';

const Page_vue_vue_type_style_index_1_scoped_7b2e7782_lang = '';
...
const _hoisted_10 = { class: "ledger" };
const _hoisted_11 = { class: "ledger-head" };
const _hoisted_12 = {
  class: "ledger-table",
  role: "table"
};
const _hoisted_13 = { class: "mono" };
const _hoisted_14 = { class: "kind" };
const _hoisted_15 = { class: "result" };
const _hoisted_16 = {
  key: 0,
  class: "ledger-empty"
};
...
const _sfc_main = {
  __name: 'Page',
  props: { api: { type: Object, default: null }, show_switch: { type: Boolean, default: false } },
...
return (_ctx, _cache) => {
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
    ...
    _createElementVNode("section", _hoisted_5, [
      ...
      _createElementVNode("div", null, [
        _cache[12] || (_cache[12] = _createElementVNode("span", null, "执行队列", -1)),
        _createElementVNode("strong", {
    ...
    _createElementVNode("section", _hoisted_6, [
      _createElementVNode("button", {
        ...
        disabled: status.value.running?.includes('strm'),
      ...
      _createElementVNode("button", {
        class: "command",
        disabled: status.value.running?.includes('upload'),
      ...
      _createElementVNode("div", _hoisted_12, [
        ...
        (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(history.value, (item, index) => {
          return (_openBlock(), _createElementBlock("div", {
            ...
            _createElementVNode("time", _hoisted_13, _toDisplayString(item.time), 1),
            _createElementVNode("span", _hoisted_14, [
              _cache[18] || (_cache[18] = _createElementVNode("i", null, null, -1)),
              _createTextVNode(_toDisplayString(item.kind), 1)
            ]),
            _createElementVNode("span", _hoisted_15, _toDisplayString(item.message || `上传 ${item.uploaded || 0}，秒传 ${item.instant || 0}，删除 ${item.deleted || 0}，STRM ${item.added || 0}`), 1)
          ]))
        }), 128)),
        (!history.value.length)
          ? (_openBlock(), _createElementBlock("div", _hoisted_16, "暂无执行记录"))
          : _createCommentVNode("", true)
      ])
    ])
  ]))
...
const Page = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-7b2e7782"]]);
